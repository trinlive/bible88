   ...
   // 2. Cache MISS - Call AI
    ...
    const prompt = `
        ...
        1. Translation: Translate to formal Thai. Use HTML <p> tags. 
           **IMPORTANT**: Start every verse with <span class="verse-num">X</span> (where X is verse number).
        2. Summary: Provide sidebar commentary in Thai using HTML.
           ...
           - Select 2-3 key terms from this chapter in their original language (Hebrew, Aramaic, Greek, or Ge'ez).
